...
import random
from utils.SegVol_segment_anything.monai_inferers_utils import select_points, generate_box
from utils.SegVol_segment_anything.loss import BCELoss, BinaryDiceLoss
