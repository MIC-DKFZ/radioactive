        ...
        for label_name, label_val in tqdm(label_dict.items(), desc = 'looping through organs\n', leave = False):
            ...
            if 'points' in supported_prompts:
                experiments.update({
                    ...
                    'point_propagation': lambda: prUt.point_propagation(inferer, img, prUt.get_seed_point(organ_mask, exp_params.n_seed_points_point_propagation, seed), slices_to_infer, seed, exp_params.n_points_propagation, verbose = False),
                })
