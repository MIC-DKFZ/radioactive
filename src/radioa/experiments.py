...
from radioa.model.model_utils import get_wanted_supported_prompters
from radioa.prompts.prompt_hparams import PromptConfig
from radioa.prompts.prompter import static_prompt_styles
...
from radioa.utils.io import verify_results_dir_exist
    ...
    if not only_eval:
        ...
        for img_path, gt_path in tqdm(imgs_gts, desc="looping through files ...", leave=False, disable=is_on_cluster):
            ...
            if not instance_gt_path.exists():
                instance_nib, _ = get_instance_nib_and_instance_ids(gt_path)
