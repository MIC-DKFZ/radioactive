...
# ========== Utility Functions ==========
def generate_latex_with_grey_background(df: pd.DataFrame, grey_shades: Dict[str, str]) -> str:
    """Generates LaTeX table rows with grey background for specified models."""
...
if __name__ == '__main__':
    ...
    latex_table: str = generate_latex_with_grey_background(sorted_df, GREY_SHADES)
    print(latex_table)
