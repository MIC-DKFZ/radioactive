...
prompter_names = {'PointPropagationPrompter': ['5P Prop', '7'],
                  ...
                  'ThreePointInterpolationPrompter': ['3P Inter', '3'],
                  'ThreeFGPointsPer2DSlicePrompter': ['3PPS', '3X' ],
                  ...
                  'ThreeBoxInterpolationPrompter_nonperfect3': ['3B Inter $\pm$3', '6'],
                  'ThreeBoxInterpolationPrompter_nonperfect5':['3B Inter $\pm$5', '6'],
                  }
