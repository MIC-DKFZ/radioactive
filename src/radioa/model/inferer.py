...
import numpy as np
from radioa.prompts.prompt import Boxes3D, PromptStep
from radioa.utils.transforms import transform_prompt_to_model_coords
...
class Inferer(ABC):
    ...
    def predict(
        self,
        prompts: PromptStep,
        prev_seg: nib.Nifti1Image,
        promptstep_in_model_coord_system: bool,
    ...
    def transform_to_model_coords_dense(
        self, nifti: Path | nib.Nifti1Image, is_seg: bool
    ...
    def transform_promptstep_to_model_coords(self, prompt_orig: PromptStep) -> PromptStep:
        return transform_prompt_to_model_coords(
            prompt_orig, self.transform_to_model_coords_sparse, self.transform_reverses_order
        )
