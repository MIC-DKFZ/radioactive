...
from intrab.model.model_utils import sammed3d_lazy, segvol_lazy
...
if __name__ == "__main__":
    ...
    results_path = os.path.join(
        results_dir, model_name + "_" + dataset_name
    )  # leave out time stamping  + '_' + datetime.now().strftime("%Y%m%d_%H%M"))
    ...
    imgs_gts = {
        "Tr": [
            (
                "/home/t722s/Desktop/Datasets/segvolTest/Case_image_00001_0000.nii.gz",
                "/home/t722s/Desktop/Datasets/segvolTest/Case_label_00001.nii.gz",
            )
        ],
        "Ts": [],
