...
from intrab.model import SAM2
from intrab.model.model_utils import checkpoint_registry
...
import intrab.prompts.interactive_prompter as i
import intrab.prompts.prompter as p
