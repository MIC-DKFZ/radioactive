...
def modify_config(template_path, models):
    for model in models:
        ...
        special_titles = {
            'sammed3d_turbo': 'SAMMED3DTurbo',
            'sammed3d_turbonorm': 'SAMMED3DTurboNORM'
        }
        ...
        for dataset_number in range(1, 12):  # From D1 to D11
            ...
            for i in range(len(lines)):
                if lines[i].strip() == "models:":
                    ...
                    lines[i] = lines[i].lstrip('# ').replace("# -", "-")  # Uncomment the line
                    break
            ...
            new_file_path = Path(template_path).parent / f'interactive_prompt_{title_model}_D{dataset_number}.yaml'
...
if __name__ == "__main__":
    template_path = "configs/template_interactive.yaml"
